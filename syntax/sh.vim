...
if !exists("skip_sh_syntax_inits")
 ...
 hi def link shFunction	Underlined
 ...
 " comments
 hi def link shComment		Comment
 " if, else, etc && echo, <<<, etc
 hi def link shConditional		Comment
 hi def link shStatement		Comment
 " variables inside strings etc
 ...
 hi def link shSpecial		Identifier
 hi def link shSpecialDQ		Identifier
 hi def link shSpecialSQ		Identifier
endif
